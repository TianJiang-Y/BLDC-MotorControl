...
//	static float dpid = 0.0, dpid_pre = 0.0;
	...
	//U1RS232_PRINT("[0]P:%f I:%f D:%f \t", pitchPPara, pitchIPara, pitchDPara);
#endif
...
*/
	...
	//U1RS232_PRINT("et:%f dP:%f dI:%f dD:%f dpid:%f \r\n", et, dP, dI, dD, dpid);
	//U1RS232_PRINT("%f,%f\r\n", et, dpid);
	return dpid;
}
...
//	static float indexICal = 0.0;
	...
	//U1RS232_PRINT("%f,%f,%f,", yawPPara, yawIPara, yawDPara);
#endif
